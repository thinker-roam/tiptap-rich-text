declare const PluginHandlerSelect_base: {
    new (...args: any[]): {
        shadowRoot: ShadowRoot;
        plugin: import("@tiptap/core").Node<any, any> | import("@tiptap/core").Mark<any, any>;
        dialog: import("./PluginDialog").PluginDialog;
...
} & import("ts-mixin-extended").MixinConstructor<HTMLElement> & {
    new (): HTMLSelectElement;
    prototype: HTMLSelectElement;
};
declare class PluginHandlerSelect extends PluginHandlerSelect_base {
    onchange: (this: GlobalEventHandlers, ev: Event) => any;
}
declare function registerPluginHandlerSelect(name: string, constructor: CustomElementConstructor): void;
