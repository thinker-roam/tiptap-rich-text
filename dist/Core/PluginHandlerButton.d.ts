declare const PluginHandlerButton_base: {
...
declare class PluginHandlerButton extends PluginHandlerButton_base {
    onclick: (this: GlobalEventHandlers, ev: MouseEvent) => any;
}
declare function registerPluginHandlerButton(name: string, constructor: CustomElementConstructor): void;
