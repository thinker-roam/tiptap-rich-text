...
declare const HashtagPlugin_base: {
    new (): {
        dialogTemplateId: string;
        dialog: import("../../../Core/createSuggestionPluginDialog").SuggestionPluginDialogType;
        plugin: import("@tiptap/core").Node<import("../../../Customs/CustomMention").CustomOptions, any>;
        getItems(query: string): Promise<{}[]>;
        handle(props: import("@tiptap/suggestion").SuggestionProps<any>): void;
        insert(range: import("@tiptap/core").Range, data: Record<string, string>): void;
...
declare class HashtagPlugin extends HashtagPlugin_base {
    dialogTemplateId: string;
    dialog: HashtagPluginDialog;
    static getItems(query: string): Promise<{}[]>;
    getItems(query: string): Promise<{}[]>;
}
