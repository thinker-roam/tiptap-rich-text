...
declare const MentionPluginDialog_base: {
    new (): {
        mode: "inline";
        plugin: (name: string) => import("@tiptap/core").Node<import("../../../Customs/CustomMention").CustomOptions, any>;
        readonly listContainer: HTMLUListElement;
        renderSelectMenuOptions(options: any[]): void;
        getSelectedItem(): HTMLLIElement;
        getSelectedItemIndex(): number;
        setSelectedItem(item: number | HTMLLIElement): void;
        shadowRoot: ShadowRoot;
        defaultMode: string;
        namedFields: Record<string, HTMLElement>;
        readonly richText: import("../../RichText/RichText").RichText;
        ...
        removeEventListener<K_1 extends keyof HTMLElementEventMap>(type: K_1, listener: (this: HTMLDialogElement, ev: HTMLElementEventMap[K_1]) => any, options?: boolean | EventListenerOptions): void;
        ...
        pmViewDesc?: {
            ...
            nearestDesc(dom: Node, onlyNodes?: boolean): any;
            getDesc(dom: Node): any;
...
declare class MentionPluginDialog extends MentionPluginDialog_base {
    mode: "inline";
    plugin: typeof CustomMention;
}
